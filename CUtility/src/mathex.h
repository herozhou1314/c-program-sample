...
int DivideInternally2D(const double p1[2], const double p2[2], int m, int n,
		double result[2]);
int DivideExternally2D(const double p1[2], const double p2[2], int m, int n,
		double result[2]);
double *Triangle_CenterOfGravity(const double p1[2], const double p2[2],
		const double p3[2], double result[2]);
double DistanceLineToDepth(double a, double b, double c, double point[2]);
double DistancePlaneToDepth(double a, double b, double c, double d,
		double point[3]);
...
double *VectorSum(const double *vec1, const double *vec2, double *sumVec,
		size_t n);
double *VectorDifference(const double *vec1, const double *vec2, double *sumVec,
		size_t n);
...
double *NormalVector3D(const double *p1, const double *p2, const double *p3,
		double *result);
...
double NormalizedVectorDistance(const double *vec1, const double *vec2,
		size_t n);
int IsDepthOnLine3D(const double *p1, const double *p2, const double *p);
void CalculatePlane3D(const double *AB, const double *AC, const double *A,
		double *a, double *b, double *c, double *d);
void CalculatePlane3D_Using3Depths(double P1[3], double P2[3], double P3[3],
		double *a, double *b, double *c, double *d);
int ToLineCanonicalForm(double a, double b, double *ga, double *gb, double *gc);
int ToPlaneCanonicalForm(double a, double b, double c, double *ga, double *gb,
		double *gc, double *gd);
int ToPlaneGenericForm(double a, double b, double c, double d, double *ca,
		double *cb, double *cc);
